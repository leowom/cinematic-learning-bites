        ...
        <GlassmorphismCard className="mb-6">
          ...
          <div className="mb-6">
            ...
            <Textarea
              ...
              placeholder="Es: 'Riassumi il PDF in 5 bullet point' o 'Spiegamelo come a un ragazzo di 15 anni'"
              className="min-h-[100px] mb-4 bg-slate-800/50 border-slate-600 text-white placeholder-slate-400"
              disabled={!pdfText}
            />
              ...
              <div className="flex flex-wrap gap-2">
                {suggestedPrompts.map((suggestion, index) => (
                  <Button
                    ...
                    className="text-xs text-slate-300 bg-slate-800/50 hover:bg-slate-700/50"
                    disabled={!pdfText}
                  >
                    {suggestion}
                  </Button>
            ...
            <Button
              ...
              disabled={!pdfText || !prompt.trim() || isProcessing}
