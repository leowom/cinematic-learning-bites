          ...
          <div className="max-w-4xl mx-auto">
            <div className="step-card glassmorphism-base text-center">
              <div className="section-spacing">
                ...
                <div className="bg-yellow-900/20 border border-yellow-700/40 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
                  <p className="text-yellow-300 text-sm">
                    💡 <strong>Modalità Simulazione:</strong> Non serve API key! 
                    Useremo risposte simulate per concentrarti sull'apprendimento.
                  </p>
                </div>
                  ...
                  {steps.map((step, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className={`font-medium text-sm ${
                            index === currentStep ? 'text-blue-300' : completedSteps[index] ? 'text-emerald-300' : 'text-slate-300'
                          }`}>
                            Esercizio {index + 1}
                          </span>
                        </div>
                      ...
                      <h4 className={`font-semibold text-sm ${
                        index === currentStep ? 'text-white' : 'text-slate-200'
                      }`}>
                        {step.title}
                      </h4>
                    </div>
                ...
                <div className="mb-4">
                  <div className="relative">
                    <Textarea
                      ...
                      className="bg-slate-800/50 border-slate-700/50 text-slate-200 placeholder:text-slate-400 min-h-[80px] resize-none"
                      onKeyDown={(e) => {
