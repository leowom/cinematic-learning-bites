...
import { Home, Play, CheckCircle, Clock, User, BookOpen, Award, RotateCcw, ChevronDown, ChevronRight, Menu } from 'lucide-react';
                              ...
                              <div className="flex items-start space-x-3 flex-1 min-w-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  <h4 className={`font-semibold text-sm leading-tight mb-1 ${
                                    module.id === 'modulo-1' ? 'text-white' : 'text-slate-200'
                                  }`}>
                                    {module.title}
                                  </h4>
                              ...
                              {module.lessons.map((lesson, index) => (
                                <div
                                  ...
                                  className={`p-4 pl-16 cursor-pointer transition-all duration-200 border-l-4 ${
                                    lesson.current && module.id === 'modulo-1'
                                  ...
                                  <div className="flex items-start justify-between">
                                    <div className="flex-1 min-w-0 pr-3">
                                      <h5 className={`text-sm font-medium leading-tight ${
                                        lesson.current && module.id === 'modulo-1' ? 'text-blue-300' : 'text-slate-300'
                                      }`}>
                                        {lesson.title}
                                      </h5>
                                    </div>
